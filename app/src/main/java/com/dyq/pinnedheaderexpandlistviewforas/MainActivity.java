package com.dyq.pinnedheaderexpandlistviewforas;
...
import com.dyq.pinnedheaderexpandlistviewforas.entity.Group;
import com.dyq.pinnedheaderexpandlistviewforas.entity.People;
import com.dyq.pinnedheaderexpandlistviewforas.ui.PinnedHeaderExpandableListView;
import com.dyq.pinnedheaderexpandlistviewforas.ui.StickyLayout;
...
public class MainActivity extends AppCompatActivity implements
            ...
            if (convertView == null) {
                ...
                button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(MainActivity.this, "clicked pos="+childPosition, Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public boolean onChildClick(ExpandableListView parent, View v,int groupPosition, int childPosition, long id) {
        Toast.makeText(MainActivity.this,childList.get(groupPosition).get(childPosition).getName(), 1)
                .show();
    ...
    public boolean giveUpTouchEvent(MotionEvent event) {
        ...
        if (expandableListView.getFirstVisiblePosition() == 0) {
            ...
            if (view != null && view.getTop() >= 0) {//如果Header显示时，外部滚动
                //StickLayout消费了onTouchEvent()
                return true;
            }
        }

        //StickLayout不消费onTouchEvent()，内部ListView滚动
        return false;
    }
